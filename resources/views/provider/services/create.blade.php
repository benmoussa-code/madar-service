    ...
    <div class="py-16 bg-[#f8fafc] min-h-screen">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-10 flex items-center justify-between">
                <div class="space-y-1">
                    <h1 class="text-4xl font-black text-slate-900 tracking-tight">Ajouter un Service</h1>
                    <p class="text-slate-400 text-sm font-medium">Parlez-nous de votre expertise pour commencer.</p>
                </div>
            ...
            <div class="bg-white rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-slate-100 p-10 md:p-14">
                <form action="{{ route('provider.services.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    @csrf
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="description" rows="6" required 
                            class="w-full rounded-2xl border-slate-100 bg-slate-50/50 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 py-4 px-6 text-sm transition-all placeholder:text-slate-300" 
                            placeholder="Décrivez votre service, vos compétences et ce qui vous rend unique...">{{ old('description') }}</textarea>
